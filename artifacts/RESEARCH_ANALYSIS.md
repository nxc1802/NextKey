...
1. **Topo-A Wide/Shallow (96/160, 1 Layer) đạt hiệu năng tốt nhất**:
   ...
   - Điều này chứng minh giả thuyết nghiên cứu trong `refactor.md`: *Với bài toán sequence tagging cấp độ ký tự, mở rộng bề rộng (Width: 160 units) với 1 layer sâu mang lại biểu diễn ngữ cảnh cục bộ tốt hơn nhiều so với việc xếp chồng nhiều layer hẹp.*

2. **Width-XS (54K params, 216 KB) là ứng viên lý tưởng cho Edge Device / Bàn phím On-device**:
   - Kích thước mô hình chỉ **216 KB** (nhỏ hơn 50 lần so với ngân sách 10MB).
   - Đạt CER **6.83%** trên In-domain và **9.24%** trên External.
   - Khoảng cách CER so với bản chuẩn chỉ chênh lệch ~2%, hoàn toàn phù hợp để làm Student Model trong Phase 3 (Distillation) hoặc nén INT8 xuống dưới **100 KB**.
