...
```bash
!if [ -d /kaggle/working/NextKey/.git ]; then git -C /kaggle/working/NextKey pull --ff-only origin main; else git clone https://github.com/nxc1802/NextKey.git /kaggle/working/NextKey; fi
